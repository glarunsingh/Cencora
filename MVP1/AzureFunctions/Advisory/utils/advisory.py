...
from Advisory.utils.advisory_summary import get_summary,get_summ_sent_key
...
class AdvisoryCrawl:
    ...
    async def get_news_data(self,main_url="https://www.advisory.com/daily-briefing/",scrape_existing=False,persist=True,department_name="Health systems",source_name="Advisory"):
        """
