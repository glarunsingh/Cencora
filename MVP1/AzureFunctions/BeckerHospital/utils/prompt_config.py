...
You will be provided with a client name , you need to identify if the content contains full name of the client name or is related to that client 
...
From the above given data extract the following information
    ...
    3. Identify if the content name is mentioned in the article or is relevant to the given client name, return the response in True or False.Read the whole article to come to conclusion. Do not make up.
