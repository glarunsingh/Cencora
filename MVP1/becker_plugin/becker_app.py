...
async def becker_news(search:source):
    ...
    try:
        if news_source.lower() == "becker review hospital":
            # duration = ["all","start=20","start=40","start=60","start=80","start=100","start=120","start=140","start=160","start=180","start=200","start=220","start=240","start=260","start=280","start=300"]
...
if __name__=="__main__":
    uvicorn.run('becker_app:app',host="127.0.0.1",port=4700, reload=False)
