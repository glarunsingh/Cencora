...
from utils.llm_prompts import template, content_template, article_list_template
from utils.load_model import model
from utils.logs import create_log
from utils.url_parameters import date_format
...
async def llm_article_list(raw_text):
    ...
    try:
        ...
        for item in article_properties:
            ...
            temp['date'] = date_format(item.date)
